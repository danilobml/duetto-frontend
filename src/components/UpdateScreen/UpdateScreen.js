    ...
    <div className="mt-12">
      <form onSubmit={(e) => handleSubmit(e)} className="p-10 pb-1 bg-white rounded-xl drop-shadow-sm space-y-3" style={{ width: "97%", maxWidth: "500px" }}>
        ...
        <div class="flex items-center mb-4">
          ...
          <input onChange={(e) => handleCheckbox(e)} id="online" type="checkbox" name="online" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" checked={loggedUser.online ? true : false} />
